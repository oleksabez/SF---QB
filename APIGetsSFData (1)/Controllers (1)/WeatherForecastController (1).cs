    ...
    public class WeatherForecastController : ControllerBase
    {
        ...
        public async Task Get()
        {
            ...
            foreach (purchaseOrderRecord po in displayResp)
            {
                ...
                string poNum = Regex.Match(po.Name, "[0-9]+", RegexOptions.IgnoreCase).Value;
                poNum = Regex.Replace(poNum, "^[0]+", "");
                ...
                thisVendorNumber = Regex.Match(po.Vendor_Order__c, "[0-9]+", RegexOptions.IgnoreCase).Value;
                ...
                if(po.All_outbound_wires_inserted__c &&
                    ...
                    !exBills.ContainsKey(Regex.Match(po.IRA_Account__c, "[0-9]+", RegexOptions.IgnoreCase).Value))
                {
                    Dictionary<string, List<string>> vendorNames =
                        new Dictionary<string, List<string>>();
                    string lastVendor = "";
                        ...
                        List<string>> kvp in vendorNames)
                    {
                        ...
                        } else
                        {
                            ...
                            AddBill.BuildBillAddRq(queryBillCreate,
                                ...
                                po.Date_Cleared__c,
                                po.Name,
                                Regex.Match(po.IRA_Account__c,"[0-9]+", RegexOptions.IgnoreCase).Value,
                                null, 
                                po.Total_Cost__c, 
                                thisCustomerName, 
                                extendedCustomerName);
